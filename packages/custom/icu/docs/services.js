...
exports.load = function(swagger, parms) {
      ...
      parameters: [
        {
          name: "body",
          description:
            "User's profile to update.  User will be inferred by the authenticated user.",
          required: true,
          type: "{}",
          paramType: "body",
          allowMultiple: false
  ...
  var uploadAvatar = {
    spec: {
      ...
      notes:
        "<p>Request URL: host/api/avatar.</p> <p>You can use it with html file upload, for example: https://github.com/danialfarid/ng-file-upload.</p>",
      type: "{}",
  ...
  var tasksList = {
    spec: {
      ...
      params: searchParms,
      parameters: [
        swagger.paramTypes.query("start", "start", "string"),
  ...
  var createTask = {
    spec: {
      ...
      notes:
        "When creating from discussion , remove the last {s} from discussions",
      type: "Task",
      nickname: "createTask",
      produces: ["application/json"],
      parameters: [
  ...
  var createAttachment = {
    spec: {
      ...
      produces: ["multipart/form-data"],
      notes:
        '<p>You can use it with html file upload, for example: https://github.com/danialfarid/ng-file-upload.</p><p> On fields you must send {issue: "string", issueId: "string"}.</p><p>------------------------there is a problem to create via swagger, because you can\'t upload file------------------</p>'
    }
  };
  ...
  var commentCreate = {
    spec: {
      ...
      notes:
        "------------------------there is a problem to create via swagger, because you don't have req.user------------------",
      type: "Comment",
