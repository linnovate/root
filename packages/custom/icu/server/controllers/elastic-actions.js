    ...
    if(!err && users.length)  {
      users.forEach(function(user) {
        ...
        user.publishFields = {
          ...
          field_address_text: user.publishFields.field_address_text !== undefined      ? user.publishFields.field_address_text      : !!user.commercial,
          field_geo_points: user.publishFields.field_geo_points !== undefined        ? user.publishFields.field_geo_points        : !!user.commercial,
          allAddress: user.publishFields.allAddress !== undefined              ? user.publishFields.allAddress              : !!user.commercial,
          field_address_guidlines: user.publishFields.field_address_guidlines !== undefined ? user.publishFields.field_address_guidlines : !!user.commercial,
