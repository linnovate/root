...
angular
  .module("mean.icu.ui.folderlistdirective", ["dragularModule"])
  .directive("icuFolderList", function(
    $state,
    $uiViewScroll,
    $stateParams,
    $timeout,
    ...
    function link($scope, $element) {
      ...
      $scope.isCurrentState = function(id) {
        var isActive =
          ($state.current.name.indexOf("main.folders.byparent.details") === 0 ||
            $state.current.name.indexOf("main.folders.byentity.details") ===
              0 ||
    ...
    return {
      restrict: "A",
      templateUrl:
        "/icu/components/folder-list-directive/folder-list.directive.template.html",
      scope: {
        folders: "=",
        loadNext: "=",
        loadPrev: "=",
