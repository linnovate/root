...
angular
  .module("mean.icu.ui.attachmentdetails", [])
  .controller("AttachmentDetailsController", AttachmentDetailsController);

function AttachmentDetailsController(
  $scope,
  $http,
  entity,
  tasks,
  ...
  EntityService.getByEntityId(attachment.entity, attachment.entityId).then(
    res => ($scope.attLinkToEntityName = res)
  );

  $scope.attLinkToEntity =
    "/" + attachment.entity + "/all/" + attachment.entityId + "/documents";
