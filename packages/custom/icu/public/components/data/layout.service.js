...
angular
  .module("mean.icu.data.layoutservice", [])
  .service("LayoutService", function() {
    ...
    function getLayoutIcon() {
      if (state === 1) return "/icu/assets/img/sections2.svg";
      else if (state === 2) return "/icu/assets/img/sections1.svg";
      else if (state === 3) return "/icu/assets/img/sections2.svg";
      else return "/icu/assets/img/sections3.svg";
    }
    function getSideMenuIcon() {
      if (state === 4) {
        return "/icu/assets/img/sections4.svg";
      } else if (state === 1) return "/icu/assets/img/sections7.svg";
    }
