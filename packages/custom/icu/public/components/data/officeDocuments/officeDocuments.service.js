...
angular
  .module("mean.icu.data.officedocumentsservice", [])
  .service("OfficeDocumentsService", function(
    $http,
    $stateParams,
    ApiUri,
    Upload,
    ...
    function deleteDocument(id) {
      return $http
        ...
        .then(entity =>
          BoldedService.boldedUpdate(entity, "officeDocuments", "update")
        );
    }

    function deleteDocumentFile(id) {
      return $http
        .post(ApiUri + EntityPrefix + "/deleteDocumentFile/" + id)
        .then(function(result) {
          return result.status;
        });
    }
    ...
    function addSerialTitle(document1) {
      return $http
        .post(ApiUri + EntityPrefix + "/addSerialTitle", document1)
        .then(function(result) {
          WarningsService.setWarning(result.headers().warning);
          return result.data;
        });
    ...
    function signOnDocx(document1, signature) {
      ...
      return $http
        .post(ApiUri + EntityPrefix + "/signOnDocx", json)
        .then(function(result) {
          WarningsService.setWarning(result.headers().warning);
          return result.data;
        });
    ...
    function createDocument(data) {
      return $http
        .post(ApiUri + EntityPrefix + "/create", data)
        .then(function(result) {
          WarningsService.setWarning(result.headers().warning);
          NotifyingService.notify("editionData");
          return result.data;
    ...
    function update(entity, data) {
      return $http
        .post(ApiUri + EntityPrefix + "/" + entity._id, data)
        .then(function(result) {
          WarningsService.setWarning(result.headers().warning);
          return result.data;
        })
    ...
    function uploadDocumentFromTemplate(template, officeDocument) {
      ...
      return $http
        .post(ApiUri + EntityPrefix + "/uploadDocumentFromTemplate", json)
        .then(function(result) {
          WarningsService.setWarning(result.headers().warning);
          return result.data;
        });
    ...
    function star(officeDocument) {
      return $http
        .patch(ApiUri + EntityPrefix + "/" + officeDocument._id + "/star", {
          star: !officeDocument.star
        })
        .then(function(result) {
          WarningsService.setWarning(result.headers().warning);
    ...
    function uploadEmpty(officeDocument) {
      return $http
        .post(ApiUri + EntityPrefix + "/uploadEmpty", officeDocument)
        .then(function(result) {
          WarningsService.setWarning(result.headers().warning);
          return result.data;
        });
    ...
    function sendDocument(sendingForm, officeDocument) {
      ...
      return $http
        .post(ApiUri + EntityPrefix + "/sendDocument", data)
        .then(function(result) {
          WarningsService.setWarning(result.headers().warning);
          return result.data;
        });
    ...
    function receiveDocument(officeDocument) {
      ...
      return $http
        .post(
          ApiUri + EntityPrefix + "/receiveDocument/" + officeDocument._id,
          data
        )
        .then(function(result) {
          WarningsService.setWarning(result.headers().warning);
    ...
    function distributedDocument(officeDocument) {
      ...
      return $http
        .post(
          ApiUri + EntityPrefix + "/distributedDocument/" + officeDocument._id,
          data
        )
        .then(function(result) {
          WarningsService.setWarning(result.headers().warning);
    ...
    function readByDocument(officeDocument) {
      ...
      return $http
        .post(
          ApiUri + EntityPrefix + "/readByDocument/" + officeDocument._id,
          data
        )
        .then(function(result) {
          return result.data;
    ...
    function sentToDocument(officeDocument) {
      ...
      return $http
        .post(
          ApiUri + EntityPrefix + "/sentToDocument/" + officeDocument._id,
          data
        )
        .then(function(result) {
          return result.data;
    ...
    function getFolderIndex(officeDocument) {
      return $http
        .post(
          ApiUri + EntityPrefix + "/" + officeDocument._id + "/indexInFolder",
          officeDocument
        )
        .then(function(result) {
          return result.data;
