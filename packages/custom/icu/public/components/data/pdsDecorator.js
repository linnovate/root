...
var passiveDataSrtuctureDecorator = function($delegate) {
  ...
  function action(cb) {
    return function(entity, context, watcherAction, watcherId) {
      ...
      return cb(entityData, context, watcherAction, watcherId).then(function(
        result
      ) {
...
angular
  .module("mean.icu.decorators.pdsDecorator")
  .decorator("ActivitiesService", passiveDataSrtuctureDecorator);
angular
  .module("mean.icu.decorators.pdsDecorator")
  .decorator("TasksService", passiveDataSrtuctureDecorator);
angular
  .module("mean.icu.decorators.pdsDecorator")
  .decorator("ProjectsService", passiveDataSrtuctureDecorator);
angular
  .module("mean.icu.decorators.pdsDecorator")
  .decorator("DiscussionsService", passiveDataSrtuctureDecorator);
angular
  .module("mean.icu.decorators.pdsDecorator")
  .decorator("UsersService", passiveDataSrtuctureDecorator);
angular
  .module("mean.icu.decorators.pdsDecorator")
  .decorator("OfficesService", passiveDataSrtuctureDecorator);
angular
  .module("mean.icu.decorators.pdsDecorator")
  .decorator("FoldersService", passiveDataSrtuctureDecorator);
angular
  .module("mean.icu.decorators.pdsDecorator")
  .decorator("OfficeDocumentsService", passiveDataSrtuctureDecorator);
angular
  .module("mean.icu.decorators.pdsDecorator")
  .decorator("TemplateDocsService", passiveDataSrtuctureDecorator);
