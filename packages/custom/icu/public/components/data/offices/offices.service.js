...
angular
  .module("mean.icu.data.officesservice", [])
  .service("OfficesService", function(
    ApiUri,
    $http,
    BoldedService,
    NotifyingService,
    ...
    function update(office, context, watcherAction, watcherId) {
      ...
      return $http
        .put(ApiUri + EntityPrefix + "/" + office._id, office)
        ...
        .then(entity =>
          BoldedService.boldedUpdate(entity, "offices", "update")
        );
    }
    ...
    function star(office) {
      return $http
        .patch(ApiUri + EntityPrefix + "/" + office._id + "/star", {
          star: !office.star
        })
        .then(function(result) {
          WarningsService.setWarning(result.headers().warning);
    ...
    function WantToCreateRoom(office) {
      return $http
        .post(
          ApiUri + EntityPrefix + "/" + office._id + "/WantToCreateRoom",
          office
        )
        .then(function(result) {
          WarningsService.setWarning(result.headers().warning);
