...
angular.module('mean.icu.data.warningsservice', [])
.service('WarningsService', function( $rootScope) {
    ...
    function setWarning(warning) {
    	if(warning){
	        ...
	        $rootScope.warnings[Object.keys(warning)[0]] = warning[Object.keys(warning)[0]];


	    	if(warning[Object.keys(warning)[0]].indexOf('connect ECONNREFUSED') >= 0 ){
