...
angular.module('mean.icu.ui.officedocumentlistdirective', ['dragularModule'])
    .directive('icuOfficeDocumentList', function ($state, $uiViewScroll, $stateParams, $timeout, context, UsersService, LayoutService) {
        ...
        function controller($scope, orderService, OfficeDocumentsService, dragularService, $element, $interval, $window) {
        ...
        function link($scope, $element) {
            ...
            $scope.isCurrentState = function (id) {
                var isActive = ($state.current.name.indexOf('main.officeDocuments.byparent.details') === 0 ||
                    $state.current.name.indexOf('main.officeDocuments.byentity.details') === 0 ||
