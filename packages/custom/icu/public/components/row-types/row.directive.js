...
*/
angular
  .module("mean.icu.ui.rows", [])
  .directive("icuListRow", function(
    $compile,
    $http,
    $templateRequest,
    $i18next,
    ...
    var templates = {
      ...
      "search-discussion":
        "/icu/components/row-types/search-discussion-row.html",
      "search-attachment":
        "/icu/components/row-types/search-attachment-row.html",
      ...
      "search-officeDocument":
        "/icu/components/row-types/search-officeDocument-row.html",
      "search-officedocument":
        "/icu/components/row-types/search-officeDocument-row.html",
      "search-templateDoc":
        "/icu/components/row-types/search-templateDoc-row.html",
    ...
    function compileTemplate(
      ...
      scope.checkMultipleMode = () =>
        (scope.multipleSelectMode =
          MultipleSelectService.getSelected().length > 0);
      ...
      $scope.bluring = function(entity, $event) {
        ...
        if (config.direction === "rtl") {
          $event.target.children.length === 0
            ...
            : scrollRight($event.target.firstChild);
        } else {
          $event.target.children.length === 0
            ? scrollLeft($event.target)
            : scrollLeft($event.target.firstChild);
        }
      };
    }
