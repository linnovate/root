"use strict";
angular
  .module("mean.icu.ui.modalcompartmentalization", [])
  .directive("icuCompModal", function($state, $uibModal, circlesService) {
    function link(scope, elem, attrs) {
      ...
      function c19n() {
        if (
          ...
          scope.entity.circles.c19n &&
          scope.entity.circles.c19n.length
        ) {
          ...
          if (
            scope.entity.circles.c19nGroups1 &&
            scope.entity.circles.c19nGroups1.length
          )
            scope.c19n.push(
              scope.mine.allowed.c19nGroups1.find(function(c) {
                return c._id === scope.entity.circles.c19nGroups1[0];
              }).name
            );

          if (
            scope.entity.circles.c19nGroups2 &&
            scope.entity.circles.c19nGroups2.length
          )
            scope.c19n.push(
              scope.mine.allowed.c19nGroups2.find(function(c) {
    ...
    return {
      ...
      template:
        '<div tooltips tooltip-template-url="/icu/components/modal-compartmentalization/tooltip.html" tooltip-side="left"></div>',
      link: link
    };
  });

function CompModalCtrl(
  $scope,
  $uibModalInstance,
  entity,
  entityName,
  ...
  for (var i = 0; i < data.allowed.c19nGroups1.length; i++) {
    $scope.c19n.lists.c19nGroups1Obj[data.allowed.c19nGroups1[i]._id] =
      data.allowed.c19nGroups1[i];
  }
  ...
  for (var i = 0; i < data.allowed.c19nGroups2.length; i++) {
    $scope.c19n.lists.c19nGroups2Obj[data.allowed.c19nGroups2[i]._id] =
      data.allowed.c19nGroups2[i];
  }
  ...
  $scope.showSelect = function() {
    if (!$scope.entity.sources[0]) {
      ...
      if (
        !$scope.entity.circles.c19nGroups1 ||
        !$scope.entity.circles.c19nGroups1[0]
      ) {
        $scope.c19n.isShown.c19nGroups1 = true;
      }
      if (
        !$scope.entity.circles.c19nGroups2 ||
        !$scope.entity.circles.c19nGroups2[0]
      ) {
