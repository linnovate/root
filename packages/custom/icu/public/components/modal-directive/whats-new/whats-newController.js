function controllerwhatsNew($scope, $uibModalInstance, $filter,$location) {
    ...
    $(document).ready(function(){
        ...
        var str = "<li data-target=\"#myCarousel\" data-slide-to=\"0\"><hr class=\"carousel-progress-bar\" /></li>";
        $('.whatsNewList').append(str);
         Object.keys($scope.whatsNew).forEach(function(wn){
             var str = "<li data-target=\"#myCarousel\" data-slide-to=\""+wn+"\"><hr class=\"carousel-progress-bar\" /></li>";
             $('.whatsNewList').append(str);
         });
