...
angular.module('mean.icu.ui.subprojectslistdirective', [])
    .directive('icuSubProjectList', function($state, $uiViewScroll, $stateParams, $timeout, UsersService) {
        ...
        function controller($scope, ProjectsService, UsersService) {
            ...
            $scope.select = function(selectedProject) {
                ...
                $scope.createOrUpdate($scope.projects[currentProject + 1])
