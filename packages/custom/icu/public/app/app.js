  ...
  function($meanStateProvider) {
    ...
    var generateStateByEntity = function(main) {
      ...
      resolve.tags = [
        "$injector",
        function($injector) {
          let service = $injector.get(
            main[0].toUpperCase() + main.slice(1) + "sService"
          );
          if (typeof service.getTags === "function") {
            return service.getTags().then(function(tags) {
              return tags;
            });
          } else {
            return [];
      ...
      return {
        ...
        resolve: {
          entity: function($state, $stateParams, tasks, results, TasksService) {
            let task = _(tasks.data || tasks).find(
              t => t._id === $stateParams.id
            );
      ...
      return {
        ...
        resolve: {
          entity: function(
            ...
            let project = _(projects.data || projects).find(
              t => t._id === $stateParams.id
            );
    ...
    function getOfficeDocumentDetailsState(urlPrefix) {
      ...
      return {
        ...
        views: {
          "detailspane@main": {
            templateUrl:
              "/icu/components/officeDocument-details/officeDocument-details.html",
        ...
        resolve: {
          entity: function(
            ...
            let officeDocument = (officeDocuments.data || officeDocuments).find(
              t => t._id === $stateParams.id
            );
            return officeDocument && typeof officeDocument === "object"
              ? officeDocument
      ...
      return {
        ...
        resolve: {
          entity: function(
            ...
            let office = _(offices.data || offices).find(
              t => t._id === $stateParams.id
            );
            return office && typeof office === "object"
              ? office
    ...
    function getTemplateDocDetailsState(urlPrefix) {
      ...
      return {
        ...
        views: {
          "detailspane@main": {
            templateUrl:
              "/icu/components/templateDoc-details/templateDoc-details.html",
        ...
        resolve: {
          entity: function(
            ...
            let templateDoc = _(templateDocs.data || templateDocs).find(
              t => t._id === $stateParams.id
            );
            return templateDoc && typeof templateDoc === "object"
              ? templateDoc
      ...
      return {
        ...
        resolve: {
          entity: function(
            ...
            let folder = _(folders.data || folders).find(
              t => t._id === $stateParams.id
            );
    ...
    function getDiscussionDetailsState(urlPrefix) {
      ...
      return {
        ...
        views: {
          "detailspane@main": {
            templateUrl:
              "/icu/components/discussion-details/discussion-details.html",
        ...
        resolve: {
          entity: function(
            ...
            let discussion = _(discussions.data || discussions).find(
              t => t._id === $stateParams.id
            );
            return discussion && typeof discussion === "object"
              ? discussion
    ...
    function getAttachmentDetailsState(urlPrefix) {
      ...
      return {
        ...
        views: {
          "detailspane@main": {
            templateUrl:
              "/icu/components/attachment-details/attachment-details.html",
    ...
    function getAttachmentDetailsTabState(main, tab) {
      return {
        ...
        views: {
          tab: {
            templateUrl:
              "/icu/components/attachment-details/tabs/versions/versions.html",
    ...
    $meanStateProvider
      ...
      .state("main.people.byentity.details.folders", {
        ...
        views: {
          tab: {
            templateUrl:
              "/icu/components/user-details/tabs/folders/folders.html",
      ...
      .state("main.people.byentity.details.activities", {
        ...
        views: {
          tab: {
            stateateUrl:
              "/icu/components/user-details/tabs/activities/activities.html",
      ...
      .state("main.people.byentity.details.documents", {
        ...
        views: {
          tab: {
            templateUrl:
              "/icu/components/user-details/tabs/documents/documents.html"
          }
        }
      })
      .state("main.tasks", {
      ...
      .state(
        "main.tasks.all.details.activities",
        getDetailsTabState("task", "activities")
      )
      .state(
        "main.tasks.all.details.documents",
        getDetailsTabState("task", "documents")
      )
      .state(
        "main.tasks.all.details.officeDocuments",
        getDetailsTabState("task", "officeDocuments")
      )

      .state("main.tasks.byentity", generateStateByEntity("task"))
      .state("main.tasks.byentity.details", getTaskDetailsState())
      .state(
        "main.tasks.byentity.details.activities",
        getDetailsTabState("task", "activities")
      )
      .state(
        "main.tasks.byentity.details.documents",
        getDetailsTabState("task", "documents")
      )
      .state(
        "main.tasks.byentity.details.officeDocuments",
        getDetailsTabState("task", "officeDocuments")
      )
      .state(
        "main.tasks.byentity.details.tasks",
        getDetailsTabState("task", "tasks")
      )
      ...
      .state(
        "main.tasks.byassign.activities",
        getDetailsByAssignTabState("activities")
      )
      .state(
        "main.tasks.byassign.documents",
        getDetailsByAssignTabState("documents")
      )
      .state("main.tasks.byassign.details", getTaskDetailsState())
      .state(
        "main.tasks.byassign.details.activities",
        getDetailsTabState("task", "activities")
      )
      .state(
        "main.tasks.byassign.details.documents",
        getDetailsTabState("task", "documents")
      )
      .state(
        "main.tasks.byassign.details.officeDocuments",
        getDetailsTabState("task", "officeDocuments")
      )
      ...
      .state(
        "main.tasks.byparent.activities",
        getDetailsTabState("task", "activities")
      )
      .state(
        "main.tasks.byparent.documents",
        getDetailsTabState("task", "documents")
      )
      .state("main.tasks.byparent.details", getTaskDetailsState())
      .state(
        "main.tasks.byparent.details.activities",
        getDetailsTabState("task", "activities")
      )
      .state(
        "main.tasks.byparent.details.documents",
        getDetailsTabState("task", "documents")
      )
      ...
      .state(
        "main.tasks.officeDocument.activities",
        getDetailsTabState("officeDocument", "activities")
      )
      .state(
        "main.tasks.officeDocument.documents",
        getDetailsTabState("officeDocument", "documents")
      )
      .state(
        "main.tasks.officeDocument.details",
        getOfficeDocumentDetailsState()
      )
      .state(
        "main.tasks.officeDocument.details.activities",
        getDetailsTabState("officeDocument", "activities")
      )
      ...
      .state(
        "main.projects.all.details.activities",
        getDetailsTabState("project", "activities")
      )
      .state(
        "main.projects.all.details.documents",
        getDetailsTabState("project", "documents")
      )
      .state(
        "main.projects.all.details.tasks",
        getDetailsTabState("project", "tasks")
      )

      .state("main.projects.byentity", generateStateByEntity("project"))
      .state("main.projects.byentity.details", getProjectDetailsState())
      .state(
        "main.projects.byentity.details.activities",
        getDetailsTabState("project", "activities")
      )
      .state(
        "main.projects.byentity.details.documents",
        getDetailsTabState("project", "documents")
      )
      .state(
        "main.projects.byentity.details.tasks",
        getDetailsTabState("project", "tasks")
      )
      ...
      .state(
        "main.projects.byparent.activities",
        getDetailsTabState("project", "activities")
      )
      .state(
        "main.projects.byparent.documents",
        getDetailsTabState("project", "documents")
      )
      .state("main.projects.byparent.details", getProjectDetailsState())
      .state(
        "main.projects.byparent.details.activities",
        getDetailsTabState("project", "activities")
      )
      .state(
        "main.projects.byparent.details.documents",
        getDetailsTabState("project", "documents")
      )
      .state(
        "main.projects.byparent.details.tasks",
        getDetailsTabState("project", "tasks")
      )
      ...
      .state(
        "main.officeDocuments.all.details.activities",
        getDetailsTabState("officeDocument", "activities")
      )
      .state(
        "main.officeDocuments.all.details.documents",
        getDetailsTabState("officeDocument", "documents")
      )
      .state(
        "main.officeDocuments.all.details.tasks",
        getDetailsTabState("officeDocument", "tasks")
      )

      .state(
        "main.officeDocuments.byentity",
        generateStateByEntity("officeDocument")
      )
      .state(
      ...
      .state(
        "main.officeDocuments.byentity.details.activities",
        getDetailsTabState("officeDocument", "activities")
      )
      .state(
        "main.officeDocuments.byentity.details.documents",
        getDetailsTabState("officeDocument", "documents")
      )
      .state(
        "main.officeDocuments.byentity.details.tasks",
        getDetailsTabState("officeDocument", "tasks")
      )
      ...
      .state(
        "main.discussions.all.details.activities",
        getDetailsTabState("discussion", "activities")
      )
      .state(
        "main.discussions.all.details.documents",
        getDetailsTabState("discussion", "documents")
      )
      .state(
        "main.discussions.all.details.tasks",
        getDetailsTabState("discussion", "tasks")
      )
      ...
      .state(
        "main.discussions.byentity.details.activities",
        getDetailsTabState("discussion", "activities")
      )
      .state(
        "main.discussions.byentity.details.documents",
        getDetailsTabState("discussion", "documents")
      )
      .state(
        "main.discussions.byentity.details.tasks",
        getDetailsTabState("discussion", "tasks")
      )
      ...
      .state(
        "main.offices.all.details.activities",
        getDetailsTabState("office", "activities")
      )
      .state(
        "main.offices.all.details.documents",
        getDetailsTabState("office", "documents")
      )
      .state(
        "main.offices.all.details.folders",
        getDetailsTabState("office", "folders")
      )
      .state(
        "main.offices.all.details.signatures",
        getDetailsTabState("office", "signatures")
      )

      .state("main.offices.byentity", generateStateByEntity("office"))
      .state("main.offices.byentity.details", getOfficeDetailsState())
      .state(
        "main.offices.byentity.details.activities",
        getDetailsTabState("office", "activities")
      )
      .state(
        "main.offices.byentity.details.documents",
        getDetailsTabState("office", "documents")
      )
      .state(
        "main.offices.byentity.details.folders",
        getDetailsTabState("office", "folders")
      )
      .state(
        "main.offices.byentity.details.signatures",
        getDetailsTabState("office", "signatures")
      )
        ...
        resolve: {
          templateDocs: function(TemplateDocsService, $stateParams) {
            if ($stateParams.starred) {
              ...
              //       }
              return TemplateDocsService.getAll(
                $stateParams.start,
                $stateParams.limit,
                $stateParams.sort
              );
      ...
      .state(
        "main.templateDocs.all.details.activities",
        getDetailsTabState("templateDoc", "activities")
      )
      .state(
        "main.templateDocs.all.details.documents",
        getDetailsTabState("templateDoc", "documents")
      )
      .state(
        "main.templateDocs.all.details.folders",
        getDetailsTabState("templateDoc", "folders")
      )
      ...
      .state(
        "main.templateDocs.byentity.details.activities",
        getDetailsTabState("templateDoc", "activities")
      )
      .state(
        "main.templateDocs.byentity.details.documents",
        getDetailsTabState("templateDoc", "documents")
      )
      .state(
        "main.templateDocs.byentity.details.folders",
        getDetailsTabState("templateDoc", "folders")
      )
      ...
      .state(
        "main.folders.all.details.activities",
        getDetailsTabState("folder", "activities")
      )
      .state(
        "main.folders.all.details.documents",
        getDetailsTabState("folder", "documents")
      )
      .state(
        "main.folders.all.details.tasks",
        getDetailsTabState("folder", "tasks")
      )
      .state(
        "main.folders.all.details.officeDocuments",
        getDetailsTabState("folder", "officeDocuments")
      )

      .state("main.folders.byentity", generateStateByEntity("folder"))
      .state("main.folders.byentity.details", getFolderDetailsState())
      .state(
        "main.folders.byentity.details.activities",
        getDetailsTabState("folder", "activities")
      )
      .state(
        "main.folders.byentity.details.documents",
        getDetailsTabState("folder", "documents")
      )
      .state(
        "main.folders.byentity.details.folders",
        getDetailsTabState("folder", "folders")
      )
      .state(
        "main.folders.byentity.details.tasks",
        getDetailsTabState("folder", "tasks")
      )
      .state(
        "main.folders.byentity.details.officeDocuments",
        getDetailsTabState("folder", "officeDocuments")
      )
      ...
      .state(
        "main.search.task.activities",
        getDetailsTabState("task", "activities")
      )
      .state(
        "main.search.task.documents",
        getDetailsTabState("task", "documents")
      )
      .state(
        "main.search.task.officeDocuments",
        getDetailsTabState("task", "officeDocuments")
      )

      .state("main.search.project", getProjectDetailsState("/project"))
      .state(
        "main.search.project.activities",
        getDetailsTabState("project", "activities")
      )
      .state(
        "main.search.project.documents",
        getDetailsTabState("project", "documents")
      )
      .state(
        "main.search.project.tasks",
        getDetailsTabState("project", "tasks")
      )

      .state("main.search.discussion", getDiscussionDetailsState("/discussion"))
      .state(
        "main.search.discussion.activities",
        getDetailsTabState("discussion", "activities")
      )
      .state(
        "main.search.discussion.documents",
        getDetailsTabState("discussion", "documents")
      )
      .state(
        "main.search.discussion.tasks",
        getDetailsTabState("discussion", "tasks")
      )

      .state("main.search.office", getOfficeDetailsState("/office"))
      .state(
        "main.search.office.activities",
        getDetailsTabState("office", "activities")
      )
      .state(
        "main.search.office.documents",
        getDetailsTabState("office", "documents")
      )
      .state(
        "main.search.office.folders",
        getDetailsTabState("office", "folders")
      )
      .state(
        "main.search.office.signatures",
        getDetailsTabState("office", "signatures")
      )

      .state(
        "main.search.templateDoc",
        getTemplateDocDetailsState("/templateDoc")
      )
      .state(
        "main.search.templateDoc.activities",
        getDetailsTabState("templateDoc", "activities")
      )
      .state(
        "main.search.templateDoc.documents",
        getDetailsTabState("templateDoc", "documents")
      )
      .state(
        "main.search.templateDoc.tasks",
        getDetailsTabState("templateDoc", "tasks")
      )

      .state("main.search.folder", getFolderDetailsState("/folder"))
      .state(
        "main.search.folder.activities",
        getDetailsTabState("folder", "activities")
      )
      .state(
        "main.search.folder.documents",
        getDetailsTabState("folder", "documents")
      )
      .state("main.search.folder.tasks", getDetailsTabState("folder", "tasks"))
      .state(
        "main.search.folder.officeDocuments",
        getDetailsTabState("folder", "officeDocuments")
      )

      .state(
        "main.search.officeDocument",
        getOfficeDocumentDetailsState("/officeDocument")
      )
      .state(
        "main.search.officeDocument.activities",
        getDetailsTabState("officeDocument", "activities")
      )
      .state(
        "main.search.officeDocument.documents",
        getDetailsTabState("officeDocument", "documents")
      )
      .state(
        "main.search.officeDocument.tasks",
        getDetailsTabState("officeDocument", "tasks")
      )
        ...
        resolve: {
          me: UsersService =>
            UsersService.getMe().then(result =>
              UsersService.getById(result._id)
            ),
      ...
      .state(
        "main.inbox.task.activities",
        getDetailsTabState("task", "activities")
      )
      .state(
        "main.inbox.task.documents",
        getDetailsTabState("task", "documents")
      )
      .state(
        "main.inbox.task.officeDocuments",
        getDetailsTabState("task", "officeDocuments")
      )

      .state("main.inbox.project", getProjectDetailsState("/project"))
      .state(
        "main.inbox.project.activities",
        getDetailsTabState("project", "activities")
      )
      .state(
        "main.inbox.project.documents",
        getDetailsTabState("project", "documents")
      )
      ...
      .state(
        "main.inbox.discussion.activities",
        getDetailsTabState("discussion", "activities")
      )
      .state(
        "main.inbox.discussion.documents",
        getDetailsTabState("discussion", "documents")
      )

      .state("main.inbox.office", getOfficeDetailsState("/office"))
      .state(
        "main.inbox.office.activities",
        getDetailsTabState("office", "activities")
      )
      .state(
        "main.inbox.office.documents",
        getDetailsTabState("office", "documents")
      )

      .state(
        "main.inbox.templateDoc",
        getTemplateDocDetailsState("/templateDoc")
      )
      .state(
        "main.inbox.templateDoc.activities",
        getDetailsTabState("templateDoc", "activities")
      )
      .state(
        "main.inbox.templateDoc.documents",
        getDetailsTabState("templateDoc", "documents")
      )

      .state("main.inbox.folder", getFolderDetailsState("/folder"))
      .state(
        "main.inbox.folder.activities",
        getDetailsTabState("folder", "activities")
      )
      .state(
        "main.inbox.folder.documents",
        getDetailsTabState("folder", "documents")
      )

      .state(
        "main.inbox.officeDocument",
        getOfficeDocumentDetailsState("/officeDocument")
      )
      .state(
        "main.inbox.officeDocument.activities",
        getDetailsTabState("officeDocument", "activities")
      );
  }
]);
