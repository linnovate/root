...
module.exports = function(passport) {
  ...
  // Use SAML strategy
  passport.use(
    new SamlStrategy(config.saml.strategy.options, function(profile, done) {
      User.findOne(
        {
        ...
        function(err, user) {
          ...
          if (user) {
            ...
            if (
              user.job != profile[config.saml.strategy.claims.job] ||
              !user.upn ||
              user.upn != profile[config.saml.strategy.claims.upn]
            ) {
              updateUser(user, profile, done);
            }
          ...
          user = new User({
            ...
            email: profile[config.saml.strategy.claims.email],
            id:
              profile[config.saml.strategy.claims.username] +
          ...
          user.save(function(err) {
            if (err) {
              ...
              return done(null, false, {
                message:
                  "Saml login failed, email already used by other login strategy"
              });
            } else {
          ...
          function(err, user) {
            ...
            user.save(function(err) {
              if (err) {
                ...
                return done(null, false, {
                  message:
                    "Twitter login failed, email already used by other login strategy"
                });
              } else {
                return done(err, user);
              }
          ...
          function(err, user) {
            ...
            user.save(function(err) {
              if (err) {
                ...
                return done(null, false, {
                  message:
                    "Facebook login failed, email already used by other login strategy"
                });
              } else {
                return done(err, user);
              }
          ...
          function(err, user) {
            ...
            user.save(function(err) {
              if (err) {
                ...
                return done(null, false, {
                  message:
                    "Github login failed, email already used by other login strategy"
                });
              } else {
                return done(err, user);
              }
          ...
          function(err, user) {
            ...
            user.save(function(err) {
              if (err) {
                ...
                return done(null, false, {
                  message:
                    "Google login failed, email already used by other login strategy"
                });
              } else {
                return done(err, user);
              }
          ...
          function(err, user) {
            ...
            user.save(function(err) {
              if (err) {
                ...
                return done(null, false, {
                  message:
                    "LinkedIn login failed, email already used by other login strategy"
                });
              } else {
                return done(err, user);
              }
