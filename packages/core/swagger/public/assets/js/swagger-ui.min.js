...
var Docs = {
  ...
  expandOperationsForResource: function(a) {
    ...
    $(
      "li#resource_" + Docs.escapeResourceName(a) + " li.operation div.content"
    ).each(function() {
...
(function() {
  ...
  a.main = b(function(g, m, f, l, k) {
    ...
    function e(v, u) {
      ...
      s =
        ((t = ((t = v.info), t == null || t === false ? t : t.description)),
        typeof t === h ? t.apply(v) : t);
      if (s || s === 0) {
        r += s;
      }
      ...
      s = f["if"].call(
        v,
        ((t = v.info), t == null || t === false ? t : t.termsOfServiceUrl),
    ...
    function d(u, t) {
      ...
      r +=
        ...
        j(
          ((s =
            ((s = u.info), s == null || s === false ? s : s.termsOfServiceUrl)),
  ...
  o = (function(z) {
    ...
    y.prototype.handleFileUpload = function(R, I) {
      ...
      this.invocationUrl = this.model.supportHeaderParams()
        ? ((C = this.model.getHeaderParams(R)), this.model.urlify(R, false))
    ...
    y.prototype.showStatus = function(F) {
      ...
      D = F.headers;
      J =
        D && D["Content-Type"] ? D["Content-Type"].split(";")[0].trim() : null;
      if (!H) {
